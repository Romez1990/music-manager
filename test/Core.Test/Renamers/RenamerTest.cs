...
namespace Core.Test.Renamers
{
    ...
    public class RenamerTest
    {
        ...
        private IAction _renamer;
        private IScanner _scanner;

        [Test]
        public void Renamer_RenamesAlbum_Correctly()
        {
            ...
            _renamer.Perform(albumDirectoryElement, Mode.Album);
        ...
        [Test]
        public void Renamer_RenamesBand_Correctly()
        {
            ...
            _renamer.Perform(bandDirectoryElement, Mode.Band);
        ...
        [Test]
        public void Renamer_RenamesCompilation_Correctly()
        {
            ...
            _renamer.Perform(compilationDirectoryElement, Mode.Compilation);
