...
namespace Core.Test.FileSystem
{
    public class MockFsNodeElementFactory : IFsNodeElementFactory
    {
        ...
        private readonly TestFilesLoader _testFilesLoader = new TestFilesLoader();
        ...
        public IFileElement TrackFileElement => CreateFileElement(TrackPath);
        ...
        private IDirectory ScanAlbum(KeyValuePair<DirectoryInfo, FileInfo[]> pair)
        {
            ...
            TrackPath = CutPath(tracksInfo.First());
